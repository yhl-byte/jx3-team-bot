...
from ..utils.index import format_daily_data,format_role_data,path_to_base64
from .html_generator import render_role_attribute
...
async def handle_role_detail(bot: Bot, event: GroupMessageEvent, state: T_State):
    ...
    # # 转换为图片
    image_path = await generate_html_screenshot(html_content, 1000)
    # # 发送图片
